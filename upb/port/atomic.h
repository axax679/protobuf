...
#define upb_Atomic_Load(addr, order)                                         \
  _Generic(addr,                                                             \
      UPB_ATOMIC(uintptr_t) *: _InterlockedOr64((uint64_t volatile *)(addr), \
                                                0),                          \
      default: (void *)_InterlockedOr64((uint64_t volatile *)(addr), 0))
...
#else
#define upb_Atomic_Load(addr, order) \
  (void *)_InterlockedOr64((uint64_t volatile *)(addr), 0)
...
#define upb_Atomic_Load(addr, order)                                           \
  _Generic(addr,                                                               \
      UPB_ATOMIC(uintptr_t) *: _InterlockedOr((uint32_t volatile *)(addr), 0), \
      default: (void *)_InterlockedOr64((uint32_t volatile *)(addr), 0))
...
#else
#define upb_Atomic_Load(addr, order) \
  (void *)_InterlockedOr((uint32_t volatile *)(addr), 0)
